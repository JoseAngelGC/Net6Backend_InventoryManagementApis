...
namespace InventoryManagement.Catalogs.Controller
{
    ...
    public class ArticleBrandCatalogController : ControllerBase
    {
        private readonly IGenericCatalogUseCaseInputPort<ArticleBrandCatalog> _catalogUseCaseInputPort;
        private readonly IResponseOutputPort<IResponseResult> _responseOutputPort;
        public ArticleBrandCatalogController(IGenericCatalogUseCaseInputPort<ArticleBrandCatalog> catalogUseCaseInputPort, 
        ...
        [HttpGet("items")]
        public async Task<ActionResult<IResponseResult>> GetArticleBrandItemsAsync()
        {
