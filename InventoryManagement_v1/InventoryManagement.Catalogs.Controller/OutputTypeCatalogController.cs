...
namespace InventoryManagement.Catalogs.Controller
{
    ...
    {
        private readonly IGenericCatalogUseCaseInputPort<OutputTypeCatalog> _catalogUseCaseInputPort;
        private readonly IResponseOutputPort<IResponseResult> _responseOutputPort;
        public OutputTypeCatalogController(IGenericCatalogUseCaseInputPort<OutputTypeCatalog> catalogUseCaseInputPort, IResponseOutputPort<IResponseResult> responseOutputPort)
        {
