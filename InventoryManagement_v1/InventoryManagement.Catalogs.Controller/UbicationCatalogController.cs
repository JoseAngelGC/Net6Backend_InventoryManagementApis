...
namespace InventoryManagement.Catalogs.Controller
{
    ...
    {
        private readonly IGenericCatalogUseCaseInputPort<UbicationCatalog> _catalogUseCaseInputPort;
        private readonly IResponseOutputPort<IResponseResult> _responseOutputPort;
        public UbicationCatalogController(IGenericCatalogUseCaseInputPort<UbicationCatalog> catalogUseCaseInputPort, IResponseOutputPort<IResponseResult> responseOutputPort)
        {
