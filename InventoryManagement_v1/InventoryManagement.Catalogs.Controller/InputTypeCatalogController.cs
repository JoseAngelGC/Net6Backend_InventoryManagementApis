...
namespace InventoryManagement.Catalogs.Controller
{
    ...
    {
        private readonly IGenericCatalogUseCaseInputPort<InputTypeCatalog> _catalogUseCaseInputPort;
        private readonly IResponseOutputPort<IResponseResult> _responseOutputPort;
        public InputTypeCatalogController(IGenericCatalogUseCaseInputPort<InputTypeCatalog> catalogUseCaseInputPort, IResponseOutputPort<IResponseResult> responseOutputPort)
        {
