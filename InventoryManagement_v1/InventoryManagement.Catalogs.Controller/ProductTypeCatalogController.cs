...
namespace InventoryManagement.Catalogs.Controller
{
    ...
    {
        private readonly IGenericCatalogUseCaseInputPort<ProductTypeCatalog> _catalogUseCaseInputPort;
        private readonly IResponseOutputPort<IResponseResult> _responseOutputPort;
        public ProductTypeCatalogController(IGenericCatalogUseCaseInputPort<ProductTypeCatalog> catalogUseCaseInputPort, IResponseOutputPort<IResponseResult> responseOutputPort)
        {
