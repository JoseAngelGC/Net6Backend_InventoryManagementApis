...
namespace InventoryManagement.Catalogs.Controller
{
    ...
    {
        private readonly IGenericCatalogUseCaseInputPort<CategoryCatalog> _catalogUseCaseInputPort;
        private readonly IResponseOutputPort<IResponseResult> _responseOutputPort;
        public CategoryCatalogController(IGenericCatalogUseCaseInputPort<CategoryCatalog> catalogUseCaseInputPort, 
