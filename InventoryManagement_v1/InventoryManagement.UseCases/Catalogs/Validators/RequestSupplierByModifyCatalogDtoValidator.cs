...
{
    public class RequestSupplierByModifyCatalogDtoValidator : AbstractValidator<RequestSupplierByModifyCatalogDto>
    {
        public RequestSupplierByModifyCatalogDtoValidator()
        {
            RuleFor(x => x.Id)
