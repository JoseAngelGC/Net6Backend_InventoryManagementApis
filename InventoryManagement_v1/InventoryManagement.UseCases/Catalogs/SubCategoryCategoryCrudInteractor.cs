...
{
    internal class SubCategoryCategoryCrudInteractor : IGenericCatalogUseCaseInputPort<SubCategoryCatalog>
    {
        private readonly ICatalogQueryOperationsUseCase<SubCategoryCatalog> _catalogQueryOperationsUseCase;
        private readonly ICatalogCommandOperationsUseCase<SubCategoryCatalog> _catalogCommandOperationsUseCase;
        ...
        public SubCategoryCategoryCrudInteractor(ICatalogQueryOperationsUseCase<SubCategoryCatalog> catalogQueryOperationsUseCase, 
            ICatalogCommandOperationsUseCase<SubCategoryCatalog> catalogCommandOperationsUseCase, 
        ...
        /// <summary>
        /// Get all subcatagory catalog records ordered by id and descended way.
        /// </summary>
        /// <returns>The successfully completed task.</returns>
        public async Task<Task> ShowAllRecordsAsync()
        {
            ResponseResult<IEnumerable<SubCategoryCatalog>> response = new();
        ...
        /// <summary>
        /// Get one subcategory catalog record
        /// </summary>
        /// <param name="id">Appertain to subcategory catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from subcategory catalog.</param>
        /// <returns>The successfully completed task.</returns>
        ...
        public async Task<Task> ShowRecordAsync(int id, RequestCatalogDto request)
        {
            ...
            ResponseResult<SubCategoryCatalog> response = new();
        ...
        /// <summary>
        /// Create subcategory catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from subcategory catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        public async Task<Task> CreateRecordAsync(RequestCatalogDto request)
        {
            ...
            else
            {
                request.Id = 0;
                request.Code = null;
                var entityMapping = _mapper.Map<SubCategoryCatalog>(request);
        ...
        /// <summary>
        /// Update subcategory catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from subcategory catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        /// <summary>
        /// Remove subcategory catalog record
        /// </summary>
        /// <param name="id">Appertain to subcategory catalog record identifier.</param>
        /// <param name="request">Appertain to requestDto object from subcategory catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        /// <exception cref="CustomBadRequestException"></exception>
