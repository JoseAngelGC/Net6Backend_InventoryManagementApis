...
{
    internal class ArticleBrandCatalogCrudInteractor : IGenericCatalogUseCaseInputPort<ArticleBrandCatalog>
    {
        private readonly ICatalogQueryOperationsUseCase<ArticleBrandCatalog> _catalogQueryOperationsUseCase;
        private readonly ICatalogCommandOperationsUseCase<ArticleBrandCatalog> _catalogCommandOperationsUseCase;
        ...
        public ArticleBrandCatalogCrudInteractor(ICatalogQueryOperationsUseCase<ArticleBrandCatalog> catalogQueryOperationsUseCase, 
            ICatalogCommandOperationsUseCase<ArticleBrandCatalog> catalogCommandOperationsUseCase, 
        ...
        /// <summary>
        /// Get all article brand catalog records ordered by id and descended way.
        /// </summary>
        /// <returns>The successfully completed task.</returns>
        public async Task<Task> ShowAllRecordsAsync()
        {
            ResponseResult<IEnumerable<ArticleBrandCatalog>> response = new();
        ...
        /// <summary>
        /// Get one single article brand catalog record
        /// </summary>
        /// <param name="id">Appertain to article brand catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from article brand catalog.</param>
        /// <returns>The successfully completed task.</returns>
        ...
        public async Task<Task> ShowRecordAsync(int id, RequestCatalogDto request)
        {
            ...
            ResponseResult<ArticleBrandCatalog> response = new();
        ...
        /// <summary>
        /// Create article brand catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from article brand catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        public async Task<Task> CreateRecordAsync(RequestCatalogDto request)
        {
            ...
            else
            {
                request.Id = 0;
                request.Code = null;
                var entityMapping = _mapper.Map<ArticleBrandCatalog>(request);
        ...
        /// <summary>
        /// Update article brand catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from article brand catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        /// <summary>
        /// Remove article brand catalog record
        /// </summary>
        /// <param name="id">Appertain to article brand catalog record identifier.</param>
        /// <param name="request">Appertain to requestDto object from article brand catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        /// <exception cref="CustomBadRequestException"></exception>
