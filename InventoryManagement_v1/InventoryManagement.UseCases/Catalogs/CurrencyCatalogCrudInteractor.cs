...
{
    public class CurrencyCatalogCrudInteractor : IGenericCatalogUseCaseInputPort<CurrencyTypeCatalog>
    {
        ...
        /// <summary>
        /// Create currency type catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from currency type catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        /// <exception cref="CustomBadRequestException"></exception>
        ...
        /// <summary>
        /// Update currency type catalog record
        /// </summary>
        /// <param name="request">Appertain to requestDto object from currency type catalog.</param>
        /// <returns>The successfully completed task.</returns>
        /// <exception cref="ValidationException"></exception>
        ...
        /// <summary>
        /// Remove currency type catalog record
        /// </summary>
        /// <param name="id">Appertain to catalog identifier.</param>
        /// <param name="request">Appertain to requestDto object from currency type catalog.</param>
        /// <returns>The successfully completed task.</returns>
